        ...
        <div class="container">
            <div class="header-box p-4 text-center d-flex justify-content-between align-items-center">
                ...
                <div class="filter gap-3 d-flex flex-row align-items-center justify-content-between ">
                    <form action="{{ route('tambah_jawaban_action') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="float-end">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="pertanyaan" id="exampleFormControlTextarea1" rows="5"
                                            placeholder="Buat Pertanyaan" readonly> {{ $data->pertanyaan }}</textarea>
                                    </div>
                                    <input type="text" name="pertanyaan_id" value="{{ $data->id }}"
