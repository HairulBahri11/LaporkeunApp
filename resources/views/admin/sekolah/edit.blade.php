        ...
        <div class="container">
            <div class="header-box p-4 text-center d-flex justify-content-between align-items-center">
                ...
                <div class="filter gap-3 d-flex flex-row align-items-center justify-content-between ">
                    <form action="{{ route('edit_sekolah_action', $data->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah"
                                            required value="{{ $data->nama_sekolah }}">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="editor2" name="misi" class="form-control" rows="3">{{ $data->misi }}</textarea>
                                    </div>
