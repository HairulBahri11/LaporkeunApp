        ...
        <div class="container">
            <div class="header-box p-4 text-center d-flex justify-content-between align-items-center">
                ...
                <div class="filter gap-3 d-flex flex-row align-items-center justify-content-between ">
                    <form action="{{ route('edit_siswa_action', $tb_user->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="nisn" class="form-control"
                                            id="exampleFormControlInput1" required value="{{ $tb_siswa->nisn }}">
                                    </div>
                                    <div class="mb-3">
