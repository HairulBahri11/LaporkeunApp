        ...
        <div class="container">
            <div class="header-box p-4 text-center d-flex justify-content-between align-items-center">
                ...
                <div class="filter gap-3 d-flex flex-row align-items-center justify-content-between ">
                    <form action="<?php echo e(route('edit_siswa_action', $tb_user->id)); ?>" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="nisn" class="form-control"
                                            id="exampleFormControlInput1" required value="<?php echo e($tb_siswa->nisn); ?>">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kelas" class="form-control"
                                            id="exampleFormControlInput1" placeholder="8 D" required
                                            value="<?php echo e($tb_siswa->kelas); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Tahun Masuk</label>
                                        <input type="text" name="tahun_masuk" class="form-control"
                                            id="exampleFormControlInput1" placeholder="8 D" required
                                            value="<?php echo e($tb_siswa->tahun_masuk); ?>">
                                    </div>
                                    <div class="mb-3">
...
<?php echo $__env->make('component.layout_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_2\htdocs\Laporkeun\resources\views/admin/siswa/edit.blade.php ENDPATH**/ ?>