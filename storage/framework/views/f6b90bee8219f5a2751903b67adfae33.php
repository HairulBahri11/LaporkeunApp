...
<body class="gradient-custom">
    ...
    <div class="container ">
        <div class="box-login p-4">
            <form class="p-5 form-login" action="<?php echo e(route('register_action')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="logo-box">
                ...
                <div class="register mt-3">
                    <span>Anda sudah memiliki akun ? <a href="<?php echo e('login'); ?>"> Login</a> disini</span>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\xampp_2\htdocs\Laporkeun\resources\views/register.blade.php ENDPATH**/ ?>